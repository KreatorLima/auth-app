            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg border border-gray-100 dark:border-gray-700/50">
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 border-b border-gray-100 dark:border-gray-700/60 pb-4">
                        <p class="text-sm text-gray-600 dark:text-gray-400">Adicione uma nova categoria para organizar as matérias e dicas do seu blog.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('categorias.store') }}"> 
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Ex: Tendências, Produtos..."
